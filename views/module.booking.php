...
<form action="'.BASE_URL.'result.php" target="_blank" rel="noopener">
<input type="hidden" name="hotel_code" value="'.$booking_code.'">
    ...
    <div class="container">
        <div class="arrival date-title ">
            ...
            <div  class="input-group date" data-date-format="dd-mm-yyyy">
                <input class="form-control" id="checkin" name="hotel_check_in" type="date">
                <span class="input-group-addon"><img src="images/Home-1/date-icon.png" alt="checkin"></span>
            </div>
        </div>
        <div class="departure date-title ">
            <label>Departure Date </label>
            <div  class="input-group date" data-date-format="dd-mm-yyyy">
                <input class="form-control" id="checkout" name="hotel_check_out" type="date">
                <span class="input-group-addon"><img src="images/Home-1/date-icon.png" alt="checkout"></span>
            </div>
        </div>
        <div class="find_btn date-title">
            <input type="submit" class="text-find" value="Check Availability">
            <!--<div class="text-find">-->
            <!--    Check Availability-->
            <!--</div>-->
        </div>

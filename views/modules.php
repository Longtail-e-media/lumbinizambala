...
$jVars['site:copyright']	= '<p>'.str_replace('{year}',date('Y'),$siteRegulars->copyright).' <a href="https://longtail.info/" target="_blank" rel="noopener">Developed by Longtail e-media</a></p>';

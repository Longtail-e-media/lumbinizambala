...
if(!empty($imglink)){
  ...
  background: var(--color-gradient-overlay), url("'.$img.'") no-repeat center;
    ...
    <section class="banner-tems text-center facilities_banner">
<div class="container">
<div class="banner-content">
    <h2>Facilities</h2>
    <p>Premium Facilities for Every Need!</p>
</div>
</div>
</section>
';
        ...
        foreach ($record as $recRow) {
            if(!empty($recRow->icon)){
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="wrap-best">
                        <div class="icon-best">
                            <i src="'. $recRow->icon .'" class="img-responsive"></i>
                        </div>
                        <h6 class="sky-h6">'. $recRow->title .' </h6>
                    </div>
                </div>
                ...
                if (file_exists($file_path) && $img[0] != NULL) {
                    ...
                    <div class="wrap-best">
                        <div class="icon-best">
                            <img src="' . $imglink . '" class="img-responsive" alt="'. $recRow->title .'">
                        </div>
                        <h6 class="sky-h6">'. $recRow->title .' </h6>
                    </div>
                </div>

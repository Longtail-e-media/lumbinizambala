 ...
 <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    if (!empty($packageInfo->header_image)):
                        $imageRow2 = $packageInfo->header_image; ?>
                        <div class="col-md-3" id="removeSavedimg009">
                            <div class="infobox info-bg">
                                <div class="button-group" data-toggle="buttons">
                                    <span class="float-left">
                                        <?php
                                        if (file_exists(SITE_ROOT . "package/imgheader/" . $imageRow2)):
                                            $filesize = filesize(SITE_ROOT . "package/imgheader/" . $imageRow2);
                                            echo 'Size : ' . getFileFormattedSize($filesize);
                                        endif;
                                        ?>
                                    </span>
                                    <a class="btn small float-right" href="javascript:void(0);"
                                       onclick="deleteSavedPackageimage('009');">
                                        <i class="glyph-icon icon-trash-o"></i>
                                    </a>
                                </div>
                                <img src="<?php echo IMAGE_PATH . 'package/imgheader/thumbnails/' . $imageRow2; ?>"
                                     style="width:100%"/>
                                <input type="hidden" name="header_image" value="<?php echo $imageRow2; ?>"/>

            ...
            <form action="" class="col-md-12 center-margin" id="subpackage_frm">
                ...
                <?php if ($pkg->type == 1) { ?>
                  ...
                  <div class="form-row">
                        ...
                        <div class="form-input col-md-6">
                        <textarea name="room_service" id="room_service"
                        class="medium-textarea">
                           <?php echo !empty($subpackageInfo->room_service) ? $subpackageInfo->room_service : ''; ?>
                           </textarea>
                        </div>
                    </div>
  <!-- 
                ...
                <?php if ($pkg->id == 12111) { ?>
                    ...
                    <div class="col-md-3 mt-3">
                                ...
                                <div id="preview_Company_Doc">
                                     ...
                                     style="width:100%"/>-->
                                                    <p><?php echo $subpackageInfo->image4 ?></p>

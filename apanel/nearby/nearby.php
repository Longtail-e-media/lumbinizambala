        ...
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="articles_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Google embed" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="Google_embed" id="Google_embed"
                               value="<?php echo !empty($articlesInfo->Google_embed) ? $articlesInfo->Google_embed : ""; ?>">
                    </div>
                </div>
                <!-- <div class="form-row">
                    <div class="form-label col-md-2">
